...
class NetworkManager(QObject):
  ...
  def __init__(self, parent=None):
    ...
    self.iface = QDBusInterface(SERVICE_NAME, "/org/freedesktop/NetworkManager", "", QDBusConnection.systemBus())
    # self.iface.connect("")
  ...
  def propsChanged(self, prop):
    ...
    if "PrimaryConnectionType" in msg.keys():
      self.connectionType = msg['PrimaryConnectionType']
      self.onConnectionTypeChanged.emit(self.connectionType)
