...
LIBEX_EXPORT status_t LIB_API flashtool_get_scatter_info(const struct file_info* scatter, /*IN OUT*/struct scatter_file_info_t* info);
...
LIBEX_EXPORT status_t LIB_API flashtool_connect_brom(HSESSION hs, const char8* port_name, 
                                                     const struct file_info* auth, const struct file_info* cert,
...
LIBEX_EXPORT status_t LIB_API flashtool_connect_da(HSESSION hs,                                       
                                      const struct file_info* da_name,
                                      const struct file_info* emi_container,
                                      const struct file_info* dev_parameters_cfg,
...
//!
//! <b>Returns</b>:  STATUS_OK if success, or other status indicate specified error.
LIBEX_EXPORT status_t LIB_API flashtool_download(HSESSION hs, const struct file_info* scatter, 
...
LIBEX_EXPORT status_t LIB_API flashtool_image_checksum(const struct file_info *info, const struct callbacks_struct_t* callbacks);
